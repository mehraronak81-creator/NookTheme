...
const SpinnerComponent = styled.div<Props>`
    ...
    border-color: ${(props) =>
        !props.isBlue ? 'var(--color-accent-soft, rgba(115, 130, 255, 0.15))' : 'hsla(212, 92%, 43%, 0.2)'};
    border-top-color: ${(props) => (!props.isBlue ? 'var(--color-accent, #7382FF)' : 'hsl(212, 92%, 43%)')};
    filter: drop-shadow(0 0 6px var(--color-accent-glow, rgba(115, 130, 255, 0.3)));
`;
